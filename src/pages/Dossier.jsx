...
export default function Dossier() {
    ...
    return (
        <div className="w-full max-w-5xl mx-auto flex flex-col pb-20 pt-8 px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                        ...
                        <div className="border border-white/20 p-6 space-y-6">
                            ...
                            <div className="aspect-square bg-neutral-900 border-2 border-white/10 relative overflow-hidden group">
                                ...
                                <img
                                    ...
                                    alt="ID"
                                />
                                <div className="absolute top-2 right-2 bg-red-600 text-[8px] font-bold px-1 py-0.5 text-white animate-pulse">
                                    PROBATION
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="font-mono text-[10px] text-accent-amber uppercase tracking-widest mt-1">Junior Data Analyst</p>
                                </div>

                                <div className="pt-4 border-t border-white/10 space-y-2 font-mono text-[10px] text-neutral-400">
                                    <div className="flex justify-between"><span>HIRE_DATE</span><span className="text-white">ERR_CORRUPT</span></div>
                                    <div className="flex justify-between"><span>CLEARANCE</span><span className="text-white font-bold">LEVEL_01</span></div>
                                    <div className="flex justify-between"><span>DEPT_CODE</span><span className="text-white">SEC_7G_TAX</span></div>
                                    <div className="flex justify-between"><span>STATUS</span><span className="text-red-500">MONITORED</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="lg:col-span-8 space-y-12">
                        ...
                        <div className="brutalist-panel bg-neutral-900/80 border-white/20 p-6 space-y-6">
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-end">
                                    <span className="font-mono text-[10px] text-neutral-500">REPUTATION</span>
                                ...
                                <div className="flex justify-between items-end border-t border-white/5 pt-2">
                                    <span className="font-mono text-[10px] text-neutral-500">INFLUENCE</span>
                    ...
                    <div className="border-2 border-dashed border-white/10 p-12 text-center opacity-40 grayscale group hover:opacity-100 hover:grayscale-0 transition-all">
                        ...
                        <h4 className="font-display font-bold text-white uppercase mb-2">Mental Profile Locked</h4>
                        <p className="font-mono text-[10px] uppercase tracking-[0.4em] text-neutral-500">Level 4 Clearance Required for Subject: {name}</p>
                    </div>
